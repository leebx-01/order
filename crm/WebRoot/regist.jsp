			...
			<DIV>
				<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
					<TBODY>
													...
													<TBODY>
														<TR>
															...
															<TD style="HEIGHT: 28px" width=150><INPUT id=txtName
																style="WIDTH: 130px" name="user.userCode">
															</TD>
														...
														<TR>
															...
															<TD style="HEIGHT: 28px" width=150><INPUT id=txtName
																style="WIDTH: 130px" name="user.userName">
															</TD>
															<TD style="HEIGHT: 28px" width=370><SPAN
																id=RequiredFieldValidator3
																style="FONT-WEIGHT: bold; VISIBILITY: hidden; COLOR: white">请输入登录名</SPAN>
														...
														<TR>
															...
															<TD><INPUT id=btn
																...
																type=image src="images/regist_button.gif"></TD>
														</TR>
													</TBODY>
												</TABLE>
											</TD>
						...
						<TR>
							<TD><IMG src="images/login_3.jpg" border=0>
							</TD>
						</TR>
					</TBODY>
				</TABLE>
